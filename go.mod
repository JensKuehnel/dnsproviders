module github.com/JensKuehnel/dnsproviders

go 1.12

require (
	github.com/Azure/azure-sdk-for-go v31.0.0+incompatible // indirect
	...
	github.com/aliyun/alibaba-cloud-sdk-go v0.0.0-20190703055746-de62006faf99 // indirect
